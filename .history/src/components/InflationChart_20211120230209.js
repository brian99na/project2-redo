                ...
                <AreaChart data={chartData} >
                    ...
                    <defs>
                        <linearGradient id='color' x1='0' y1='0' x2='0' y2='1'>
                            <stop offset="0%" stopColor='#F5EC80' stopOpacity={0.4}/>
                            <stop offset="75%" stopColor='#F5EC80' stopOpacity={0.05}/>
                        </linearGradient>
                    </defs>

                    <Area dataKey="CPI_index_value" fill='url(#color)' stroke='black'/>
                    <XAxis dataKey="date" axisLine={false} tickLine={false} tickCount={4}/>
