...
function InflationChart(props) {
    ...
    // let filteredCoinData = props.chartData && props.chartData.filter((coin, index) => {5
    //     return(
        ...
        <div className='inflationChart'>
            <ResponsiveContainer width="90%" height={300}>
                <AreaChart data={chartData} >
                    ...
                    <XAxis dataKey="date" axisLine={false} tickLine={false} scale='date' type="number" domain={['auto', 'auto']} interval={'preserveStartEnd'} tickCount={2}/>
